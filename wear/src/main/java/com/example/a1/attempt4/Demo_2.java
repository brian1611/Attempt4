 ...
 */
public class Demo_2 extends Activity implements MessageApi.MessageListener, GoogleApiClient.ConnectionCallbacks {
    ...
    public void drawing2(String in){
        switch (in) {
            case "BU":
                band = "up";
                image.setImageResource(R.drawable.goup);
                break;
            case "BD":
                band = "down";
                image.setImageResource(R.drawable.godown);
                break;
            case "BM":
                band = "mid";
                image.setImageResource(R.drawable.normal);
